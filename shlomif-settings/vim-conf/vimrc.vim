...
call vam#ActivateAddons(['ack', 'Add_to_Word_Search', 'c%213', 'closetag', 'Command-T', 'FuzzyFinder', 'matchit.zip', 'parrot', 'range-search', 'spec%98', 'surround', 'textobj-user', 'textobj-rubyblock', 'The_NERD_tree', 'UltiSnips', 'unite', 'vcscommand', 'VimClojure', 'vim-addon-scala', 'TT2_syntax'], {'auto_install': 0})
