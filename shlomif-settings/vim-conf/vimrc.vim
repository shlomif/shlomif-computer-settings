...
call vam#ActivateAddons(['ack', 'Add_to_Word_Search', 'c%213', 'Command-T', 'matchit.zip', 'perl-support', 'range-search', 'surround', 'The_NERD_tree', 'UltiSnips', 'vcscommand', ], {'auto_install': 0})
