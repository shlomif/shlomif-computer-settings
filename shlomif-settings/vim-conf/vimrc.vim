...
call vam#ActivateAddons(['ack', 'Add_to_Word_Search', 'c%213', 'Command-T', 'FuzzyFinder', 'matchit.zip', 'range-search', 'surround', 'The_NERD_tree', 'UltiSnips', 'vcscommand', 'VimClojure',], {'auto_install': 0})
